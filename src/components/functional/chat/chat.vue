            ...
            <div class=" h-screen">
                <div class="flex border border-grey rounded shadow-lg h-full">
                    ...
                    <div class="w-1/3 border flex flex-col">
                        ...
                        <!-- Header -->
                        <ChatHeader :contact="selectedContact"></ChatHeader>

                        <!-- Contacts -->
                        <div class="bg-grey-lighter flex-1 overflow-auto">
                            <chatContact v-for="contact in contacts" @contact-selected="" :contact="contact"></chatContact>
...
<script lang="ts" setup>
    import { text } from '@components/crud';
    import { default as chatContact } from './chat-contact.vue'
    import { default as ChatHeader } from './partials/header.vue'

    

    let contacts = [{
            name: 'Rupesh Patel',
            status: "Making awsome chat component",
            profile_image : 'https://darrenjameseeley.files.wordpress.com/2014/09/expendables3.jpeg',
            last_seen: '12:45 PM'
        },
        {
            name: 'Rupesh Patel',
